...
The Zip Deploy extension is added along with app setting `WEBSITE_RUN_FROM_PACKAGE=1` to mount the zip package for deployment. The appSetting `WEBSITE_RUN_FROM_PACKAGE=1` is not supported with Linux Consumption plan.
